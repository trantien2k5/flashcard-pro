    ...
    container.innerHTML = `
      ...
      <div class="settings-hero-banner">
        ...
        <div class="settings-hero-badges">
          <span class="settings-pill-badge" style="background: rgba(99, 102, 241, 0.12); color: var(--primary);">v2.6 Pro</span>
        </div>
      </div>
      ...
      <div class="settings-layout-grid">
        ...
        <div class="settings-card">
          <div class="settings-card-header">
            <div class="settings-card-icon fsrs">
            ...
            <div class="settings-card-title-group">
              <h3 class="settings-card-title">Thuật toán FSRS-6</h3>
              <span class="settings-card-subtitle">Tối ưu hóa khả năng ghi nhớ dài hạn</span>
            </div>
          </div>
        ...
        <div class="settings-card">
          <div class="settings-card-header">
            <div class="settings-card-icon audio">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="settings-card-title-group">
              <h3 class="settings-card-title">Âm Thanh & Giao Diện</h3>
              <span class="settings-card-subtitle">Tự động phát âm bản xứ và đổi chủ đề</span>
            </div>
          </div>
        ...
        <div class="settings-card" style="grid-column: 1 / -1;">
          <div class="settings-card-header">
            <div class="settings-card-icon" style="background: rgba(16, 185, 129, 0.12); color: #10b981;">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="settings-card-title-group">
              <h3 class="settings-card-title">Quản Lý Dữ Liệu & Sao Lưu</h3>
              <span class="settings-card-subtitle">Dữ liệu lưu 100% Offline trên máy của bạn</span>
            </div>
          </div>

          <div class="setting-row setting-actions-compact-row">
      ...
      <div class="profile-dashboard-layout">
        ...
        <div class="profile-card">
          <div class="profile-card-header">
            <div class="profile-card-icon" style="background: rgba(245, 158, 11, 0.12); color: #f59e0b;">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="profile-card-title-group">
              <h3 class="profile-card-title">Thành Tích Học Tập</h3>
              <span class="profile-card-subtitle">Tiến trình và chuỗi ngày kiên trì</span>
            </div>
          </div>
        ...
        <!-- Knowledge Base Taxonomy Card -->
        <div class="profile-card">
          <div class="profile-card-header">
            <div class="profile-card-icon" style="background: rgba(99, 102, 241, 0.12); color: #6366f1;">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            ...
            <div class="profile-card-title-group">
              <h3 class="profile-card-title">Kho Dữ Liệu Hệ Thống</h3>
              <span class="profile-card-subtitle">Cơ sở dữ liệu từ vựng tiêu chuẩn FSRS-6</span>
            </div>
          </div>
